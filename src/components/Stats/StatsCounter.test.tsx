...
import * as LandingProjectCardStories from "./StatsCounter.stories";
import { composeStories } from "@storybook/react";

const { AmazonSpaceSafetyVisualizer: LandingProjectCard } = composeStories(
  LandingProjectCardStories
);
...
describe("Landing Project Card", () => {
  beforeEach(() => {
    render(<LandingProjectCard project={projectData} />);
  });
